...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/') }}assets/css/ace-rtl.min.css" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="{{ asset('css/') }}assets/css/ace-ie.min.css" />
    <![endif]-->
        ...
        <ul class="nav nav-list">
            <li class="">
                <a href="#">
                    ...
                    <span class="menu-text"> หน้าเว็บไซต์หลัก </span>
                </a>
            ...
            <li class="">
                <a href="#">
                    ...
                    <span class="menu-text"> จัดการข้อมูล </span>
                </a>
                            ...
                            <div class="ace-settings-item">
                                <div class="pull-left">
                                    <select id="skin-colorpicker" class="hide">
                                        ...
                                        <option data-skin="no-skin" value="#438EB9">#C6487E</option>
